...
export class HomePage {
    ...
    loadInfo(){
        this._redminer.load('users/current.json?include=memberships,groups', this.key).then(data => {
    ...
    get_gravatar(email) {
        ...
        return 'https://secure.gravatar.com/avatar/' + MD5(email) + '?rating=PG&size=80&default=retro';
    }
}